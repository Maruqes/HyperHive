...
var file_virsh_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x6e, 0x65, 0x77, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x2a, 0x82, 0x01,
	...
	0x10, 0x08, 0x32, 0xad, 0x09, 0x0a, 0x11, 0x53, 0x6c, 0x61, 0x76, 0x65, 0x56, 0x69, 0x72, 0x73,
	...
	0x69, 0x72, 0x73, 0x68, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2f, 0x0a, 0x0f, 0x45, 0x64,
...
var file_virsh_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_virsh_proto_depIdxs = []int32{
	...
	13, // 24: virsh.SlaveVirshService.ChangeVmPassword:input_type -> virsh.ChangeVncPassword
	2,  // 25: virsh.SlaveVirshService.GetCpuFeatures:output_type -> virsh.GetCpuFeaturesResponse
	9,  // 26: virsh.SlaveVirshService.GetCPUXML:output_type -> virsh.CPUXMLResponse
	9,  // 27: virsh.SlaveVirshService.GetVMCPUXml:output_type -> virsh.CPUXMLResponse
	4,  // 28: virsh.SlaveVirshService.UpdateVMCPUXml:output_type -> virsh.OkResponse
	4,  // 29: virsh.SlaveVirshService.CreateVm:output_type -> virsh.OkResponse
	4,  // 30: virsh.SlaveVirshService.MigrateVM:output_type -> virsh.OkResponse
	4,  // 31: virsh.SlaveVirshService.ShutdownVM:output_type -> virsh.OkResponse
	4,  // 32: virsh.SlaveVirshService.ForceShutdownVM:output_type -> virsh.OkResponse
	4,  // 33: virsh.SlaveVirshService.StartVM:output_type -> virsh.OkResponse
	4,  // 34: virsh.SlaveVirshService.RemoveVM:output_type -> virsh.OkResponse
	4,  // 35: virsh.SlaveVirshService.RestartVM:output_type -> virsh.OkResponse
	4,  // 36: virsh.SlaveVirshService.PauseVM:output_type -> virsh.OkResponse
	4,  // 37: virsh.SlaveVirshService.ResumeVM:output_type -> virsh.OkResponse
	4,  // 38: virsh.SlaveVirshService.UndefineVM:output_type -> virsh.OkResponse
	7,  // 39: virsh.SlaveVirshService.GetAllVms:output_type -> virsh.GetAllVmsResponse
	5,  // 40: virsh.SlaveVirshService.GetVmByName:output_type -> virsh.Vm
	4,  // 41: virsh.SlaveVirshService.RemoveIsoFromVm:output_type -> virsh.OkResponse
	1,  // 42: virsh.SlaveVirshService.ChangeNetwork:output_type -> virsh.Empty
	4,  // 43: virsh.SlaveVirshService.EditVmResources:output_type -> virsh.OkResponse
	4,  // 44: virsh.SlaveVirshService.ColdMigrateVm:output_type -> virsh.OkResponse
	4,  // 45: virsh.SlaveVirshService.FreezeDisk:output_type -> virsh.OkResponse
	4,  // 46: virsh.SlaveVirshService.UnFreezeDisk:output_type -> virsh.OkResponse
	1,  // 47: virsh.SlaveVirshService.ChangeVmPassword:output_type -> virsh.Empty
