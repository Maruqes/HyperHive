...
const file_virsh_proto_rawDesc = "" +
	...
	"\x03vms\x18\x01 \x03(\v2\t.virsh.VmR\x03vms\"\x8b\x01\n" +
	"\x13CreateVmLiveRequest\x12&\n" +
	"\x02vm\x18\x01 \x01(\v2\x16.virsh.CreateVmRequestR\x02vm\x12\x1a\n" +
	"\bcpuModel\x18\x02 \x01(\tR\bcpuModel\x120\n" +
	"\x13disabledCpuFeatures\x18\x03 \x03(\tR\x13disabledCpuFeatures\"T\n" +
