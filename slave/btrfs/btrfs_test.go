...
func TestRaid0(t *testing.T) {
	...
	uuid, err := CreateRaid("raid0", &Raid0, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
	...
	_, err = MountRaid(uuid, mountPoint, CompressionZlib9)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRaid1c2(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c2", &Raid1, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
	...
	_, err = MountRaid(uuid, mountPoint, CompressionNone)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRaid1c3(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c3", &Raid1c3, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
	...
	_, err = MountRaid(uuid, mountPoint, CompressionZstd3)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRaid1c4(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c4", &Raid1c4, dev0, dev1, dev2, dev3)
	if err != nil {
		t.Error(err)
		return
	}
	...
	_, err = MountRaid(uuid, mountPoint, CompressionLZO)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestAddDiskToRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c3-add", &Raid1c3, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRemoveDiskFromRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c3-add", &Raid1c3, dev0, dev1, dev2, dev3)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestReplaceDiskFromRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid1c3-replace", &Raid1c3, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestChangeRaidLevel(t *testing.T) {
	...
	// Start with RAID0
	uuid, err := CreateRaid("raid-convert", &Raid0, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestBalanceRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-balance", &Raid1, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestDefragmentRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-defrag", &Raid1, dev0, dev1)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestScrubRaid(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-scrub", &Raid1, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestCheckBtrfsFunc(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-check", &Raid1, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
	...
	/*
		...
		_, _, err = MountRaid("raid-check", mountPoint, CompressionZstd3)
		if err != nil {
...
func TestDiskFailure(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-failure", &Raid1, dev0, dev1, dev2)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestMultipleDiskFailure(t *testing.T) {
	...
	uuid, err := CreateRaid("raid-multi-failure", &Raid1c3, dev0, dev1, dev2, dev3)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestRemoveRaidUUID_Mounted(t *testing.T) {
	...
	if _, err := MountRaid(uuid, mountPoint, CompressionNone); err != nil {
		t.Error(err)
		return
	}
