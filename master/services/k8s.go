...
func (s *K8sService) ConnectSlaveToCluster(machineName string) error {
	...
	if tokenFound == nil {
		return fmt.Errorf("slave master is not connected yet or there are bugs on the damm code")
	}
